...
public class ColumnParserTest {
    private final String DEFAULT_COLUMN_STRING = "Dimension.DATE,Ad unit 1,Ad unit 2,Ad unit ID 1,Ad unit ID 2,Column.TOTAL_AD_REQUESTS,Column.TOTAL_LINE_ITEM_LEVEL_IMPRESSIONS,Column.TOTAL_LINE_ITEM_LEVEL_CLICKS,Column.TOTAL_LINE_ITEM_LEVEL_CPM_AND_CPC_REVENUE,Column.TOTAL_ACTIVE_VIEW_VIEWABLE_IMPRESSIONS_RATE";
    private final String EXCEPTION_COLUMN_STRING = "Dimension.DATE,Ad unit 1,Ad unit 2,Ad unit 3,Ad unit ID 1,Ad unit ID 2,Ad unit ID 3,Column.TOTAL_AD_REQUESTS,Column.TOTAL_LINE_ITEM_LEVEL_IMPRESSIONS,Column.TOTAL_LINE_ITEM_LEVEL_CLICKS,Column.TOTAL_LINE_ITEM_LEVEL_CPM_AND_CPC_REVENUE,Column.TOTAL_ACTIVE_VIEW_VIEWABLE_IMPRESSIONS_RATE";
    ...
    public void extractRequiredColumn(){
        try {
        ColumnsIndexInfo columnsInfo = columnParser.getColumnIndex(DEFAULT_COLUMN_STRING);
            ...
            ColumnsIndexInfo columnsIndexInfo = columnParser.getColumnIndex(EXCEPTION_COLUMN_STRING);
    ...
    public void allColumnIndexChecked() {
        ColumnsIndexInfo columnsIndexInfo1 = columnParser.getColumnIndex(DEFAULT_COLUMN_STRING);
        assertEquals(true, columnsIndexInfo1.isAllColumnChecked());

        ColumnsIndexInfo columnsIndexInfo2 = columnParser.getColumnIndex(EXCEPTION_COLUMN_STRING);
