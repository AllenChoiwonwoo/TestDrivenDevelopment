...
public class ExpiryDateCalculatorTest {
    ...
    @Test
    void 첫_납부일과_만료일이_일자가_다를때_만원_납부(){
    ...
    private static void assertExpiryDate(LocalDate billingDate, int payAmmount, LocalDate expectedExpiryDate) {
        assertExpiryDate(new PayData(billingDate, payAmmount), expectedExpiryDate);
    }
